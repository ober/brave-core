...
//
// It answers for every quality on every build. Deferring a case to upstream
// would consult SODA and the optimization guide, which Brave does not ship, and
// report a model as downloadable that we cannot deliver.
